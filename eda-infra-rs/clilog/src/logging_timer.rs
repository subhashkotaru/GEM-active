//! This source is adapted from https://github.com/PhilipDaniels/logging_timer/blob/master/src/lib.rs.
...
impl<'name> LoggingTimer<'name> {
    ...
    pub fn new(
        ...
        if ::log::log_enabled!(level) && is_timer_enabled(module_path) {
            Some(LoggingTimer {
                level,
